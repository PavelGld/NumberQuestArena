...
export const translations = {
  ru: {
    ...
    'home.play': 'Играть',
    'home.customBoards': 'Кастомные доски',
    'home.constructor': 'Конструктор',
    'home.leaderboard': 'Лидерборд',
    'home.language': 'Язык',
    'constructor.title': 'Конструктор',
    'constructor.name': 'Название доски',
    'constructor.creatorName': 'Ваше имя',
    'constructor.save': 'Сохранить',
    'constructor.clear': 'Очистить',
    'constructor.solve': 'Решить',
    'constructor.addTarget': 'Добавить цель',
    'constructor.targets': 'Целевые числа',
    'constructor.validation': 'Сначала решите свою головоломку',
    'customBoards.title': 'Кастомные доски',
    'customBoards.popular': 'Популярные',
    'customBoards.all': 'Все',
    'customBoards.creator': 'Автор',
    'customBoards.completions': 'Решено раз',
    'customBoards.play': 'Играть',
    'nav.home': 'Главная',
    'nav.game': 'Игра',
  ...
  en: {
    ...
    'home.play': 'Play',
    'home.customBoards': 'Custom Boards',
    'home.constructor': 'Constructor',
    'home.leaderboard': 'Leaderboard',
    'home.language': 'Language',
    'constructor.title': 'Constructor',
    'constructor.name': 'Board Name',
    'constructor.creatorName': 'Your Name',
    'constructor.save': 'Save',
    'constructor.clear': 'Clear',
    'constructor.solve': 'Solve',
    'constructor.addTarget': 'Add Target',
    'constructor.targets': 'Target Numbers',
    'constructor.validation': 'Solve your puzzle first',
    'customBoards.title': 'Custom Boards',
    'customBoards.popular': 'Popular',
    'customBoards.all': 'All',
    'customBoards.creator': 'Creator',
    'customBoards.completions': 'Completions',
    'customBoards.play': 'Play',
    'nav.home': 'Home',
    'nav.game': 'Game',
    'nav.constructor': 'Create',
    'nav.boards': 'Boards',
